    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamInvitations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamInvitations_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamInvitationAttempts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamInvitationAttempts_ExamInvitations_InvitationId",
                        column: x => x.InvitationId,
                        principalTable: "ExamInvitations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamInvitationAttempts_ExamSubmissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamInvitationAttempts_InvitationId",
                table: "ExamInvitationAttempts",
                column: "InvitationId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamInvitationAttempts_SubmissionId",
                table: "ExamInvitationAttempts",
                column: "SubmissionId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamInvitations_ExamId",
                table: "ExamInvitations",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamInvitations_InvitationCode",
                table: "ExamInvitations",
                column: "InvitationCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExamInvitations_Token",
                table: "ExamInvitations",
                column: "Token",
                unique: true);
